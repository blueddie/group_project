...
class ImageCaptioningModel(tf.keras.Model):
    ...
    def call(self, inputs, training = False):
        img_tensor, caption = inputs
        img_features = self.cnn_model(img_tensor)
        return img_features
...
model.load_weights('C:\\_data\\project\\caption_model.h5')
...
img_url = "http://www.shadowsphotography.co/wp-content/uploads/2017/12/photography-01-800x400.jpg"
...
# 가중치 저장
# caption_model.save_weights('C:\\_data\\project\\caption_model.h5')
